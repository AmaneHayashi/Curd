...
public class CK_CK implements CRE.CK {
	...
	public CK_CK(String table_name) {
		this.table_name = table_name;
		table_label = table_name.substring(2);
	}

	public JFrame run() {
		jf = new CK_CK(table_name).new CKF1();
		return jf;
	}
	...
	public class CKF1P0 extends F1P0 {
		...
		public void init() {
			...
			mt2s = F1P0mt2s;
			dmcs = F1P0dmcs;
			dmcv = new String[][] { SQLSupport.sqlFillDmc("XS_DH", "关联状态", CHECKOUTING, "", new int[] { 1, 2, 3 }),
		...
		public void actionPerformed(ActionEvent e) {
			...
			// 保存
				...
				// SQLSupport.sqlUpdate("XS_DH", "关联状态", ASSOCIATING, "单号", s2, "");
	...
	public class CKF2P0 extends F2P0 {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource().equals(jb[0])) {
				...
				SQLSupport.sqlUpdate("XS_DH", "关联状态", ASSOCIATING, "单号", F1P1.asso_label, "");
